...
@section('content')
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tr class="odd gradeX" align="center">
            ...
            <td class="center"><a href="{!! URL::route('admin.contact.getChange',$item['id']) !!}" onclick="return dalienlac('Bạn có chắt muốn thay đổi trạng thái của thông tin liên lac không!!!')">
                    @if($item["status"] == 0)
                        <p>Mới</p>
