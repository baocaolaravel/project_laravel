                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{!! url('admin/cate/add') !!}" class="fa fa-plus"> Thêm danh mục</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{!! url('admin/tintuc/list') !!}" class="fa fa-list"> Danh sách tin tức</a>
                            </li>
                            <li>
                                <a href="{!! url('admin/tintuc/add') !!}" class="fa fa-plus"> Thêm tin tức</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{!! url('admin/user/list') !!}" class="fa fa-list"> Danh sách người dùng</a>
                            </li>
                            <li>
                                <a href="{!! url('admin/user/add') !!}" class="fa fa-plus"> Thêm người dùng</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
