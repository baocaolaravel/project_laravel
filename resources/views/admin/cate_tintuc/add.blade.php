...
@section('content')
    <div class="col-lg-7" style="padding-bottom:120px" >
        ...
        <form action="{!! route('admin.cate_tintuc.getAdd') !!}" method="POST" enctype="multipart/form-data">
